...
namespace GazeAnalysis
{
    ...
    void EstimateGazeR1(const LandmarkDetector::CLNF& clnf_model, cv::Point pupil_center, cv::Point3f& gaze_absolute, cv::Point3f& eyeballCentre, float fx, float fy, float cx, float cy, bool left_eye);
