...
#ifndef __YARP_IMAGE_CAPTURE_h_
#define __YARP_IMAGE_CAPTURE_h_
...
namespace Utilities
{
	...
	*/
	...
	public:
        ...
        // cv::Mat
        bool OpencvMat(cv::Mat img, float fx = -1, float fy = -1, float cx = -1, float cy = -1);
	...
	private:
		...
		yarpImageCapture & operator= (const yarpImageCapture& other);
		yarpImageCapture & operator= (const yarpImageCapture&& other);
		yarpImageCapture(const yarpImageCapture&& other);
		yarpImageCapture(const yarpImageCapture& other);
