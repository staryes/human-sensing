...
//       Tadas Baltru啾itis, Amir Zadeh, Yao Chong Lim, and Louis-Philippe Morency
//       in IEEE International Conference on Automatic Face and Gesture Recognition, 2018
//
//       Convolutional experts constrained local model for facial landmark detection.
//       A. Zadeh, T. Baltru啾itis, and Louis-Philippe Morency,
//       in Computer Vision and Pattern Recognition Workshops, 2017.
//
//       Rendering of Eyes for Eye-Shape Registration and Gaze Estimation
//       Erroll Wood, Tadas Baltru啾itis, Xucong Zhang, Yusuke Sugano, Peter Robinson, and Andreas Bulling
//       in IEEE International. Conference on Computer Vision (ICCV),  2015
//
//       Cross-dataset learning and person-specific normalisation for automatic Action Unit detection
//       Tadas Baltru啾itis, Marwa Mahmoud, and Peter Robinson
//       in Facial Expression Recognition and Analysis Challenge,
//       IEEE International Conference on Automatic Face and Gesture Recognition, 2015
//
///////////////////////////////////////////////////////////////////////////////

#include "yarpImageCapture.h"
...
bool yarpImageCapture::Open(std::vector<std::string>& arguments)
{
...
bool yarpImageCapture::OpencvMat(cv::Mat imgMat, float fx = -1, float fy = -1, float cx = -1, float cy = -1)
{
    ...
    latest_frame = imgMat;
    cv::cvtColor(imgMat, latest_gray_frame, CV_BGR2GRAY);

    image_focal_length_set = false;
    image_opticl_center_set = false;
...
bool yarpImageCapture::OpenImageFiles(const std::vector<std::string>& image_files, float fx, float fy, float cx, float cy)
{
	// Setting some defaults
	frame_num = 0;
	no_input_specified = false;
...
bool yarpImageCapture::OpenDirectory(std::string directory, std::string bbox_directory, float fx, float fy, float cx, float cy)
{
...
void yarpImageCapture::SetCameraIntrinsics(float fx, float fy, float cx, float cy)
{
...
cv::Mat yarpImageCapture::GetNextImage()
{
...
std::vector<cv::Rect_<float> > yarpImageCapture::GetBoundingBoxes()
{
...
double yarpImageCapture::GetProgress()
{
	return (double)frame_num / (double)image_files.size();
}

cv::Mat_<uchar> yarpImageCapture::GetGrayFrame()
{
